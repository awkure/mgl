...
describe("note image lightbox", () => {
  it("opens a tall media-only image without collapsing it or entering note editing", async () => {
    ...
    const game: Game = { id: GAME_ID, title: "DuckTales", coverAssetId: null, steamAppId: null, importedVia: "manually", hoursPlayed: null, lastPlayedAt: null, steamOverrides: {}, platforms: ["NES"], tags: [], status: "playing", placement: { tierId: "a", rank: 1024 }, reviewMarkdown: "", createdAt: NOW, updatedAt: NOW };
  ...
  it("keeps extreme portrait images in the fixed preview while lightbox and editing stay available", async () => {
    const user = userEvent.setup();
    const game: Game = { id: GAME_ID, title: "Wario Land 3", coverAssetId: null, steamAppId: null, importedVia: "manually", hoursPlayed: null, lastPlayedAt: null, steamOverrides: {}, platforms: ["GameBoy Color"], tags: [], status: "playing", placement: { tierId: "b", rank: 1024 }, reviewMarkdown: "", createdAt: NOW, updatedAt: NOW };
