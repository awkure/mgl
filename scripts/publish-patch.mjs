...
const FIELDS = {
  games: new Set(["title", "coverAssetId", "steamAppId", "importedVia", "hoursPlayed", "lastPlayedAt", "achievementsUnlocked", "achievementsTotal", "steamOverrides", "platforms", "tags", "status", "placement", "reviewMarkdown"]),
